 ...
 * Slot-based layout: title, prompt, and content go in fixed regions of the frame for game-show polish.
        ...
        <SurveyShowdownFrame
          ...
          contentSlot={
            <div className="feud-display__collect-inner feud-display__collect-inner--inframe">
              <p className="feud-display__muted feud-display__muted--gameshow">
              ...
              <p className="feud-display__muted feud-display__muted--gameshow" style={{ marginTop: 12, marginBottom: 8, fontSize: '0.95rem' }}>
    ...
    return (
      <div className="feud-display feud-display--locked feud-display--inframe" style={{ background: 'transparent', color: theme.text }}>
        <SurveyShowdownFrame
          ...
          contentSlot={
            <p className="feud-display__muted feud-display__muted--gameshow">Revealing top answers…</p>
          }
        />
      </div>
    );
