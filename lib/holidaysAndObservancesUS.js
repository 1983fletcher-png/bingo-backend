 ...
 *
 * TRUST & ACCURACY: Every date is cross-referenced and verified. We plan for 2026 and 2027
 * (and extend where appropriate). Nothing is published without verification.
 * @see docs/DATE-VERIFICATION-SOURCES.md
 * @see docs/CALENDAR-TRUST-AND-ACCURACY.md
 *
...
const FIXED = [
  ...
  // February: love, kindness, Black History Month start, storytelling
  ...
  { name: "National Peanut Butter Day", month: 2, day: 12, category: CATEGORIES.FOOD },
  ...
  // March: St. Patrick's, spring, reading, wildlife, crafts
  ...
  // April: Easter, Earth, books, beer, jazz
  ...
  // May: Star Wars, mothers, tacos, wine, memorial
  ...
  // June: Doughnut, Father's, summer, Pride
  ...
  // July: Independence, fireworks, summer, ice cream
  ...
  // August: summer, dog, left-handers, book lovers
  ...
  // September: back to school, grandparents, coffee, fall
  ...
  // October: Halloween, fall, pasta, pizza
  ...
  // November: Thanksgiving, veterans, turkeys, kindness
  ...
  // December: Christmas, snow, cookies, new year
