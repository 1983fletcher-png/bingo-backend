...
- DECADE: 80s (Game 1, 2, 3 — no overlap), 90s Pop, 90s Rock, 90s Hip-Hop, 2000s Hits, 70s, 60s.
...
- VIDEO GAME MUSIC: Recognizable themes and songs from video games (e.g. Mario, Zelda, Sonic, Final Fantasy, Halo, The Last of Us, licensed tracks in games). Instrumental themes and iconic game soundtracks that players and fans recognize.
- TV THEME SONGS: Classic and modern TV show theme songs and title tracks (e.g. Friends, Cheers, The Fresh Prince, Game of Thrones, Stranger Things). Widely recognizable opening/closing themes.
- MOVIES: Film soundtracks, musicals, and songs made famous by movies (e.g. Dirty Dancing, Top Gun, Guardians of the Galaxy, Disney, musicals). One song per film when possible unless theme demands otherwise.
