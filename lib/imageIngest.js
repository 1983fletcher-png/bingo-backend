...
/* -----------------------------
   ALLOWED IMAGE SOURCES (master whitelist — see docs/IMAGE-SOURCE-WHITELIST.md)
   Only these domains (or subdomains) are allowed. Reject NC, ND, paid, unclear license.
----------------------------- */
...
/** Only these display licenses allowed. Reject CC NC, CC ND, and everything else. */
